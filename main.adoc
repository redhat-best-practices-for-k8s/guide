...
This document provides guidance and best practices information for developing OpenShift applications that use cloud-native functions (CNFs) for high-performance workloads.
