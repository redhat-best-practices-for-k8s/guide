...
The default capabilities that are allowed via the restricted SCC are as follows (see link:https://github.com/cri-o/cri-o/blob/main/internal/config/capabilities/capabilities_linux.go[cri-o Linux capabilities])
