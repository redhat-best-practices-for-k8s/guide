...
link:https://docs.openshift.com/container-platform/4.17/scalability_and_performance/what-huge-pages-do-and-how-they-are-consumed-by-apps.html[Configuring huge pages].
